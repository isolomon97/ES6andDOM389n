...
function addBook() {
  ...
  if (valid === false){
    alert("Please fill in all fields properly. Make sure pages field is a number greater than 0, and that all fields are filled.");
  }
  else{
    if (type === "TextBook"){
...
else{//is a number, need to check if negative
  if (parseInt(pages) < 1){
    valid = false;
  }
}
